import { APIResponseKnowledgeData } from "domain/Knowledge/models/Knowledge";
import { AIRTABLE_API_URL } from "domain/shared/api/constant";
import { APIResponse } from "domain/shared/models/ApiResponse";

export async function fetchKnowledgeAPI(): Promise<APIResponse<APIResponseKnowledgeData> | null> {
  try {
